...
require 'rails-ext/generated_attribute'

class TestGeneratedAttribute < Test::Unit::TestCase
  def test_can_initialize_with_defaults
    attribute = Rails::Generator::GeneratedAttribute.new('MyField', "string(255)")
  ...
  def test_can_create_string_migration_declaration_with_null
    attribute = Rails::Generator::GeneratedAttribute.new('MyField', 'string(255)', 'Default Value')
  ...
  def test_can_create_string_migration_declaration_without_null
    attribute = Rails::Generator::GeneratedAttribute.new('MyField', 'string(255)', 'Default Value', false)
